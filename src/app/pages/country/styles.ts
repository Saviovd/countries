...
.country_container {
    ...
    .back {
        ...
        padding: 14px;
        border-radius: 8px;
        box-shadow: 15px 15px 28px 15px rgba(${props => props.theme.colors.secundary_text}, 0.08);
        text-align: center;
        margin-left: 50px;
    ...
    .country_box {
        ...
        .countries_border {
            ...
            .country_border {
                box-shadow: 15px 15px 28px 15px rgba(${props => props.theme.colors.secundary_text}, 0.05);
                border-radius: 3px;
                margin: 2px 5px;
                padding: 6px 10px;
                min-width: 70px;
